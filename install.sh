...
echo "   I'm building [describe your project]. Use OAW's architecture as the harness, map this project's real state into AI_CONTEXT.md, then tell me which repeated workflows belong in .agents/skills/."
echo ""
