...
echo ""
echo "   先讀 CLAUDE.md，再讀 AI_CONTEXT.md。"
echo "   對照架構，把這個專案的真實狀況填進來，然後告訴我哪些重複流程可以收進 .agents/skills/。"
echo ""
echo "   (EN) Read CLAUDE.md first, then AI_CONTEXT.md."
echo "   Analyze the codebase, fill in all \${...} placeholders with real project info,"
echo "   then suggest which repeated workflows can move into .agents/skills/."
echo ""
echo "💡 Try the tools:"
