...
身為一個在不同 AI 平台間橫跳、追求 Tokenmaxxing 的「AI 渣男」，我最不能容忍的就是 Agent 的金魚腦。如果你也受夠了 Agent 動不動就失憶、瘋狂燃燒你昂貴的 Context，導致你還沒寫到核心功能就先看到那句令人崩潰的 `You have hit your limit`，那麼你大概也會想要這套裝甲。
...
OAW 沒複製這些 repo / concept 的原始碼，但設計理念深受以下影響：

- 🔄 **Self-improving harness patterns** — 用 version / roadmap / do_not_rerun 管理 agent 進度，不要原地打轉
